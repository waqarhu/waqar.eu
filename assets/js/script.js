...
const islamicQuotes = [
  ...
  "Have they not seen that We made the night for them to rest therein and the day giving sight?",
  ...
  "And He gives you from all you ask of Him.",
  "So truly where there is hardship there is also ease.",
  "Call upon Me; I will respond to you.",
  "And those who strive for Us - We will surely guide them to Our ways.",
  "And He has not made upon you in the religion any difficulty.",
  "Indeed, Allah loves those who rely upon Him.",
  "And Allah is Knowing of all things.",
  "So which of the favors of your Lord would you deny?",
  "Verily, in the remembrance of Allah do hearts find rest.",
  "And whoever is patient and forgiving - indeed, that is of the matters requiring determination.",
  ...
  "The believer who has the most perfect faith is the one whose character is finest and who is kindest to his wife.",
  ...
  "Do not be people without minds of your own, saying that if others treat you well you will treat them well.",
  "The most complete of believers in faith are those with the best character.",
  "Whoever removes a worldly hardship from a believer, Allah will remove from him a hardship of the Hereafter.",
  ...
  "When Allah loves a servant, He calls Gabriel and says: I love so-and-so, therefore love him.",
  "Facilitate things to people and do not make it hard for them, and give them good tidings.",
  "A man's feet will not move on the Day of Judgment before he is asked about his knowledge.",
  ...
  "Faith has sixty-odd branches, the uppermost of which is the declaration 'There is no god but Allah'.",
  "Verily, Allah is more pleased with the repentance of His slave than a person who lost his camel.",
...
if (form && formInputs.length > 0 && formBtn) {
  ...
  form.addEventListener("submit", async function(e) {
    ...
    try {
      ...
      // Reset button label (keep disabled on success since form was reset)
